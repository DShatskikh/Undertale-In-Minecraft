...
namespace PixelCrushers.QuestMachine
{
    ...
    public static class QuestMachine
    {
        ...
        private static Dictionary<EntityType, List<DriveValue>> m_runtimeDriveValues = new Dictionary<EntityType, List<DriveValue>>();
        ...
        static void InitStaticVariables()
        {
            ...
            m_runtimeDriveValues = new Dictionary<EntityType, List<DriveValue>>();
        }
#endif
        ...
        public static List<DriveValue> GetRuntimeDriveValues(EntityType entityType)
        {
            if (entityType == null) return null;
            List<DriveValue> runtimeDriveValues;
            if (!m_runtimeDriveValues.TryGetValue(entityType, out runtimeDriveValues))
            {
                runtimeDriveValues = new List<DriveValue>();
                for (int i = 0; i < entityType.originalDriveValues.Count; i++)
                {
                    runtimeDriveValues.Add(new DriveValue(entityType.originalDriveValues[i]));
                }
                m_runtimeDriveValues[entityType] = runtimeDriveValues;

            }
            return runtimeDriveValues;
        }

        public static void SetRuntimeDriveValues(EntityType entityType, List<DriveValue> runtimeDriveValues)
        {
