...
namespace PixelCrushers.QuestMachine
{
    ...
    public abstract class UnityUIBaseUI : MonoBehaviour
    {
        ...
        {
            var text = headingContent.runtimeText;
            var instance = currentContentManager.AcquireTextInstance(GetHeadingTemplate(headingContent.headingLevel), text);
        ...
        {
            var text = bodyContent.runtimeText;
            var instance = currentContentManager.AcquireTextInstance(currentBodyTemplate, text);
            currentContentManager.Add(instance, currentContentContainer);
            currentIconList = null;
        }
        ...
        {
            var instance = currentContentManager.AcquireTextInstance(currentBodyTemplate, bodyContentString);
            currentContentManager.Add(instance, currentContentContainer);
        ...
        protected virtual void AddAudioContent(AudioClipQuestContent audioContent)
        {
            ...
            audioContent.useAudioSourceOn.PlayOneShot(audioContent.audioClip);
        }
