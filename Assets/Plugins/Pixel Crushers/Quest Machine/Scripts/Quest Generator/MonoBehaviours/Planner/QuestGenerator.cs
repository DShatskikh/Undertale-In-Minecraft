...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestGenerator
    {
        ...
        private IEnumerator DetermineGoal()
        {
            ...
            motive = bestMotive;
            goal = new PlanStep(mostUrgentFact, bestAction, ChooseRequiredCounterValue(mostUrgentFact));
        ...
        private int ChooseRequiredCounterValue(Fact fact)
        {
            int min = Mathf.Min(fact.count, Mathf.CeilToInt(fact.entityType.minCountInAction.Evaluate(fact.count)));
            int max = Mathf.CeilToInt(fact.entityType.maxCountInAction.Evaluate(fact.count));
