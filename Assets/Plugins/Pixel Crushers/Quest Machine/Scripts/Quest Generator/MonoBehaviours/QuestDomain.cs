...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestDomain : MonoBehaviour
    {
        ...
        [SerializeField]
        QuestEntityUnityEvent m_onEntityAdded = new QuestEntityUnityEvent();

        [SerializeField]
        QuestEntityUnityEvent m_onEntityRemoved = new QuestEntityUnityEvent();
        ...
        public UnityEvent<QuestEntity> onEntityAdded
        {
            get { return m_onEntityAdded; }
        }

        public UnityEvent<QuestEntity> onEntityRemoved
        {
            get { return m_onEntityRemoved; }
        }
