    ...
    public class ActionEditor : Editor
    {
        ...
        private void DrawCompletionConditions()
        {
            ...
            try
            {
                ...
                {
                    var messageSenderSpecifierProperty = completionProperty.FindPropertyRelative("m_senderSpecifier");
                    var messageTargetSpecifierProperty = completionProperty.FindPropertyRelative("m_targetSpecifier");
                    EditorGUILayout.PropertyField(messageSenderSpecifierProperty, new GUIContent("Sender", "Required message sender."), true);
                    if (messageSenderSpecifierProperty.enumValueIndex == (int)QuestMessageParticipant.Other)
                    {
                    ...
                    EditorGUILayout.PropertyField(messageTargetSpecifierProperty, new GUIContent("Target", "Required target sender."), true);
                    if (messageTargetSpecifierProperty.enumValueIndex == (int)QuestMessageParticipant.Other)
                    {
                ...
                else
                {
                    ...
                    if (updateModeProperty.enumValueIndex == (int)QuestCounterUpdateMode.Messages)
                    {
                        ...
                        for (int i = 0; i < messageEventListProperty.arraySize; i++)
                        {
                            ...
                            if (senderSpecifierProperty == null || senderProperty == null ||
                                targetSpecifierProperty == null || targetProperty == null ||
                                messageProperty == null || parameterProperty == null ||
                                operationProperty == null || literalValueProperty == null) return;
                            EditorGUILayout.PropertyField(senderSpecifierProperty,
                            ...
                            EditorGUILayout.PropertyField(targetSpecifierProperty,
