...
namespace PixelCrushers.QuestMachine
{
    ...
    public class Quest : ScriptableObject
    {
        ...
        public Quest Clone()
        {
            ...
            clone.offerConditionsUnmetContentList = QuestSubasset.CloneList(offerConditionsUnmetContentList, this);
            clone.offerContentList = QuestSubasset.CloneList(offerContentList, this);
            QuestStateInfo.CloneSubassets(stateInfoList, clone.stateInfoList, this);
            QuestNode.CloneSubassets(nodeList, clone.nodeList, this);
        ...
        {
            var isSpeakerQuestGiver = IsSpeakerQuestGiver(speaker);
            currentSpeaker = isSpeakerQuestGiver ? null : speaker;
            var stateInfo = GetStateInfo(GetState());
            if (isSpeakerQuestGiver && stateInfo.HasContent(category)) return true;
