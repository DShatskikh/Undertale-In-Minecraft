...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestCounterMessageEvent
    {
        ...
        public QuestCounterMessageEvent(StringField targetID, StringField message, StringField parameter, 
            Operation operation, int literalValue)
        {
            m_targetID = targetID;
            m_message = message;
        ...
        public QuestCounterMessageEvent(QuestMessageParticipant senderSpecifier, StringField senderID,
            QuestMessageParticipant targetSpecifier, StringField targetID, StringField message, StringField parameter,
            Operation operation, int literalValue)
        {
            m_senderSpecifier = senderSpecifier;
            m_senderID = senderID;
            m_targetSpecifier = targetSpecifier;
            m_targetID = targetID;
            m_message = message;
            m_parameter = parameter;
            m_operation = operation;
