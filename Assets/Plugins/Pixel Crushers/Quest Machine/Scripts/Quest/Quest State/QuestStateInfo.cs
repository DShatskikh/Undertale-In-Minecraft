...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestStateInfo
    {
        ...
        public void CloneSubassetsInto(QuestStateInfo copy, Quest quest = null)
        {
            ...
            {
                copy.actionList = QuestSubasset.CloneList(m_actionList, quest);
                for (int i = 0; i < m_categorizedContentList.Count; i++)
                {
                    ...
                    copy.categorizedContentList[i].contentList = QuestSubasset.CloneList(m_categorizedContentList[i].contentList, quest);
                }
            }
        }
        ...
        public static void CloneSubassets(List<QuestStateInfo> original, List<QuestStateInfo> copy, Quest quest = null)
        {
            // Assumes lists are identical except subassets haven't been copied.
            if (original == null)
            {
            ...
            else
            {
                ...
                {
                    original[i].CloneSubassetsInto(copy[i], quest);
                }
            }
        }
