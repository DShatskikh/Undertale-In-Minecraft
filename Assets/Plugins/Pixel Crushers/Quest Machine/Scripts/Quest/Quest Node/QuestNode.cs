...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestNode
    {
        ...
        public void CloneSubassetsInto(QuestNode copy, Quest quest = null)
        {
            // Assumes lists are identical except subassets haven't been copied.
            if (copy == null) return;
            conditionSet.CloneSubassetsInto(copy.conditionSet, quest);
            QuestStateInfo.CloneSubassets(stateInfoList, copy.stateInfoList, quest);
            tagDictionary.CopyInto(copy.tagDictionary);
        }

        public static void CloneSubassets(List<QuestNode> original, List<QuestNode> copy, Quest quest = null)
        {
            // Assumes lists are identical except subassets haven't been copied.
            ...
            {
                if (original[i] != null) original[i].CloneSubassetsInto(copy[i], quest);
            }
        }
